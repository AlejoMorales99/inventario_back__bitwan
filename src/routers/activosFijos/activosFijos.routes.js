...
const {
        ...
        getBodegasTecnicos,retiroCliente,retiroClienteEspecifico,ObtenerTecnicos,registroExcelAllActivosFijos,buscarRegistros,buscarRegistrosPorReferenciaBodega,
...
//ruta para retirar un activo fijo del cliente en especifico
router.get('/api/registroExcelAllActivosFijos', registroExcelAllActivosFijos )
